...
function Footer(){
    return (
     <div className="container">
        ...
        <div className="row">
            <div className="col-3">
                <img src="media/images/logo.svg" alt=" " className="img"></img>
                <br/>
                <img src="media/images/googleplaybadge.svg"  className="m-2" alt=""></img>
                <p>
                  &copy; 2010-2014 Zerodha Private Ltd;
                </p>
                <p>
                    All rights reserved.
                </p>
             ...
             <div className="col-3">
              ...
              <div className="col-3">
               ...
               <div className="col-3 className=img2">
                <p>
 ...
 <div className ="new  text-small text-muted">
...
<br></br><p>"Prevent unauthorised transactions in your account. Update your mobile numbers/email IDs with your stock brokers. Receive information of your transactions directly from Exchange on your mobile/email at the end of the day. Issued in the interest of investors. KYC is one time exercise while dealing in securities markets - once KYC is done through a SEBI registered intermediary (broker, DP, Mutual Fund etc.), you need not undergo the same process again when you approach another intermediary." Dear Investor, if you are subscribing to an IPO, there is no need to issue a cheque. Please write the Bank account number and sign the IPO application form to authorize your bank to make payment in case of allotment. In case of non allotment the funds will remain in your bank account. As a business we don't give stock tips, and have not authorized anyone to trade on behalf of others. If you find anyone claiming to be part of Zerodha and offering such services, please create a ticket here.
...
<p classname=" ml-5">NSE BSE MCX Terms & conditions Policies & procedures Privacy policy Disclosure For investor's attention Investor charter</p>
</div>
      </div>
    )
}
